...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 16, 2024 at 11:09 AM
...
('spatie.permission.cache', 'a:3:{s:5:\"alias\";a:0:{}s:11:\"permissions\";a:0:{}s:5:\"roles\";a:0:{}}', 1723885266);
...
--
-- Table structure for table `korekduas`
--
...
--
-- Dumping data for table `korekduas`
--
...
--
-- Table structure for table `koreksatus`
--
...
--
-- Dumping data for table `koreksatus`
--
...
--
-- Table structure for table `korektigas`
--
...
--
-- Dumping data for table `korektigas`
--
...
--
-- Table structure for table `kualitasairs`
--
...
--
-- Dumping data for table `kualitasairs`
--
...
--
-- Table structure for table `penetapanpaps`
--
...
--
-- Table structure for table `perusahaanabs`
--
...
--
-- Table structure for table `perusahaanpaps`
--
...
('6rKJhR0Jx4sAQNLO6QRtsLsOCmVKWFHg1tmSYx2C', 1, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/127.0.0.0 Safari/537.36', '', 1723799184),
('b9qsmshXxPEh203Mr4r2OWnGjURjPtJWnaLVTyYy', NULL, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/127.0.0.0 Safari/537.36', 'YTozOntzOjY6Il90b2tlbiI7czo0MDoib3NHajRlRWhVUG1MMEdxOWhocmNCMXpoN1BMUVBzMnZxc3N1TU5ZSiI7czo5OiJfcHJldmlvdXMiO2E6MTp7czozOiJ1cmwiO3M6MTY6Imh0dHA6Ly9sb2NhbGhvc3QiO31zOjY6Il9mbGFzaCI7YToyOntzOjM6Im9sZCI7YTowOnt9czozOiJuZXciO2E6MDp7fX19', 1723797962),
('J3JPn1mtYlyH1YUdZJUT2VCRRZaVeQpnl0by8r8n', 1, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/127.0.0.0 Safari/537.36', '', 1723775844);

-- --------------------------------------------------------

--
-- Table structure for table `setorbbms`
--
...
CREATE TABLE `setorbbms` (
  ...
  `transportir_id` int(20) UNSIGNED NOT NULL,
  `konsumen_id` int(20) UNSIGNED NOT NULL,
  `province_id` bigint(20) UNSIGNED NOT NULL,
  `regency_id` bigint(20) UNSIGNED NOT NULL,
  `koreksatu_id` bigint(20) UNSIGNED NOT NULL,
  `korekdua_id` bigint(20) UNSIGNED NOT NULL,
...
--
-- Dumping data for table `setorbbms`
--
...
--
-- Table structure for table `setorprs`
--
...
--
-- Dumping data for table `setorprs`
--

INSERT INTO `setorprs` (`id`, `iden`, `noreg`, `perusahaan_id`, `province_id`, `regency_id`, `koreksatu_id`, `korekdua_id`, `korektiga_id`, `volume`, `nilai`, `tglsetor`, `image`, `pegawai_id`, `created_at`, `updated_at`) VALUES
(1, '1', '2', 26, 62, 6271, 4, 32, 22, '1000', '100000000', '2024-08-07', '01J4NB2M71MJNXDQQJZYYV2T29.png', 2, '2024-08-06 19:35:49', '2024-08-06 19:35:49');
...
--
-- Table structure for table `transportirs`
--
...
(1, 'admin', 'admin@email.com', NULL, '$2y$12$rv3hPgs7bs2k9FfDCPH0K.FBlGJOu89Oj/e7HzeooUnzlOQPSLLNG', NULL, '2024-07-30 18:27:33', '2024-07-30 18:27:33'),
(2, 'Test', 'test@email.com', NULL, '$2y$12$IIvhkfXLHZnQq7lk5XgYDe4ZPepnOiAhg9RjR9qx0GNo4xTMi.uVq', NULL, '2024-07-31 03:21:06', '2024-08-07 00:56:21'),
(3, 'rafikrahman', 'rafikrahman77@gmail.com\r\n', NULL, '$P$B2ipPy.dRHLxBQbGxEL0UYiQ1nWaPf.', NULL, '2024-07-31 03:21:06', '2024-07-31 03:21:06'),
(4, 'meilany\r\n', 'ella.meilany2014@gmail.com\r\n', NULL, '$P$BAmD4UBC98ZGmlPKXfXe91Tdaf5QSx1\r\n', NULL, '2024-07-31 03:21:06', '2024-07-31 03:21:06'),
(5, 'erzapebrian\r\n', 'perza322@yahoo.com\r\n\r\n', NULL, '$P$BKdVEsLfnkdEPpPyAzhxR7OmTF7oMV.\r\n\r\n', NULL, '2024-07-31 03:21:06', '2024-07-31 03:21:06'),
(6, 'rrwalanda', 'ririe_ws@yahoo.com', NULL, '$P$BtakmGE5abdEERfbUbn.a5PoryWDpr/', NULL, '2024-07-31 03:21:06', '2024-07-31 03:21:06'),
(7, 'Kasongan', 'kasongan@email.com', NULL, '$2y$12$g8W/Jl8kpygeS6HrXKFjgu6uWokVK56IDNTMnamED8sbGh7jDRwpW', NULL, '2024-08-11 23:35:08', '2024-08-11 23:35:08'),
(8, 'palangkaraya', 'palangkaraya@email.com', NULL, '$2y$12$O.Mcpw82GV8EahoMtuPypOZ6OenR3CdYOqoX58JciuB2GZtpdGKgi', NULL, '2024-08-11 23:36:15', '2024-08-11 23:36:15'),
(9, 'pimpinan', 'pimpinan@email.com', NULL, '$2y$12$1uLDbC5ekJVvK1O/0NSTdO5584teo0sz7JY/Smwj8bTM7tCyTtTwu', NULL, '2024-08-15 00:15:54', '2024-08-15 00:15:54');
...
--
-- Indexes for table `korekduas`
--
ALTER TABLE `korekduas`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `koreksatus`
--
ALTER TABLE `koreksatus`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `korektigas`
--
...
--
-- Indexes for table `kualitasairs`
--
...
--
-- Indexes for table `penetapanpaps`
--
...
--
-- Indexes for table `perusahaanabs`
--
...
--
-- Indexes for table `perusahaanpaps`
--
...
--
-- Indexes for table `setorbbms`
--
ALTER TABLE `setorbbms`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `setorprs`
--
...
--
-- Indexes for table `transportirs`
--
...
--
-- AUTO_INCREMENT for table `korekduas`
--
ALTER TABLE `korekduas`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;

--
-- AUTO_INCREMENT for table `koreksatus`
--
ALTER TABLE `koreksatus`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT for table `korektigas`
--
ALTER TABLE `korektigas`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=36;

--
-- AUTO_INCREMENT for table `kualitasairs`
--
ALTER TABLE `kualitasairs`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
-- AUTO_INCREMENT for table `penetapanpaps`
--
ALTER TABLE `penetapanpaps`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `perusahaanabs`
--
ALTER TABLE `perusahaanabs`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `perusahaanpaps`
--
ALTER TABLE `perusahaanpaps`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `setorbbms`
--
ALTER TABLE `setorbbms`
  MODIFY `id` int(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2896;

--
-- AUTO_INCREMENT for table `setorprs`
--
ALTER TABLE `setorprs`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
-- AUTO_INCREMENT for table `transportirs`
--
ALTER TABLE `transportirs`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- Constraints for table `korektigas`
--
ALTER TABLE `korektigas`
...
--
-- Constraints for table `setorprs`
--
ALTER TABLE `setorprs`
